...
- A bridge or an AC tube flies over every street its complete width overlaps: its underside stands at least 5.5 m above that street's `level`, so one touching a highway deck starts at 13.5 m even when the two centerlines do not cross. The underside is the lower aperture base, where the miter cut reaches deepest. A link that cannot clear what it crosses is not built. Tunnels run below every street.
