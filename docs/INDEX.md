...
| --- | --- | --- | --- |
| [Root](../CONTRACT.md) | Computes links and movement networks | [Atlas](../src/types/atlas.ts), [params](../schemas/params.schema.json) / [output](../schemas/output.schema.json) | Atlas, Exterior floor families, junctions, rooftop |
