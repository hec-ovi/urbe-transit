...
- root (connections): deterministic generator and movement networks over Atlas lane, walking-band and elevation authority, contract in CONTRACT.md. Depends on Atlas and Exterior's stable external attachment contract for the rooftop pass.
