...
Results are JSON geometry and paths. Materials and model assets are outside the available API. Connections documents use version 0.9.0; rooftop documents use schema 1.0.0 and generator version 0.10.4.
